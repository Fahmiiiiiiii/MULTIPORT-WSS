...
sleep 1
wget -q -O /usr/bin/auto-set "https://raw.githubusercontent.com/Fahmiiiiiiii/MULTIPORT-WSS/main/auto-set.sh" && chmod +x /usr/bin/auto-set 
wget -q -O /usr/bin/crtxray "https://raw.githubusercontent.com/Fahmiiiiiiii/MULTIPORT-WSS/main/crt.sh" && chmod +x /usr/bin/crtxray 
sleep 1
